...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if chat_type == "private":
        # В личных сообщениях убираем поле ввода
        try:
...
async def show_main_menu(query, context):
    ...
    if chat_type == "private":
        try:
            await query.edit_message_reply_markup(reply_markup=InlineKeyboardMarkup(keyboard_buttons))
        except Exception:
...
def run_bot():
    ...
    print("Бот запущен с очисткой чата и умным полем ввода...")
